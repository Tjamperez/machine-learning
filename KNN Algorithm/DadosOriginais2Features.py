...
train_data = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Originais_2Features/TrainingData_2F_Original.txt', delimiter='\t', index_col=False)
train_data_aux = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Originais_2Features/TrainingData_2F_Original.txt', delimiter='\t', index_col=False)
# Drop the ID column
...
test_data = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Originais_2Features/TestingData_2F_Original.txt', delimiter='\t', index_col=False)
test_data_aux = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Originais_2Features/TestingData_2F_Original.txt', delimiter='\t', index_col=False)
# Drop the ID column
