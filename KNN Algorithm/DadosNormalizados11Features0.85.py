...
train_data = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Normalizados_11Features/TrainingData_11F_Norm.txt', delimiter='\t', index_col=False)
...
test_data = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Normalizados_11Features/TestingData_11F_Norm - 0.85.txt', delimiter='\t', index_col=False)
