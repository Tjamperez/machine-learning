...
train_data = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Normalizados_2Features/TrainingData_2F_Norm.txt', delimiter='\t', index_col=False)
...
test_data = pd.read_csv('./KNN Algorithm/ExercícioKNN/Dados_Normalizados_2Features/TestingData_2F_Norm - 0.85.txt', delimiter='\t', index_col=False)
